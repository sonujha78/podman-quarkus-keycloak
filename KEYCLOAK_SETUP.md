...
- Keycloak container: `podman run -d --name keycloak --network host -e KEYCLOAK_ADMIN=admin -e KEYCLOAK_ADMIN_PASSWORD=admin -e KC_HTTP_PORT=8081 quay.io/keycloak/keycloak:26.0 start-dev`
