...
This is Quarkus's core selling point over traditional frameworks like Spring Boot —
sub-second (here, sub-30-millisecond) startup makes it ideal for serverless,
Kubernetes autoscaling, and cold-start-sensitive workloads.
